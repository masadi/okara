...
class ReferensiController extends Controller
{
    ...
    public function add_kd(){
        ...
        $insert = Kompetensi_dasar::create([
            ...
            'kelas_1' => (request()->tingkat == 1) ? 1 : 0,
            'kelas_2' => (request()->tingkat == 2) ? 1 : 0,
            'kelas_3' => (request()->tingkat == 3) ? 1 : 0,
            'kelas_4' => (request()->tingkat == 4) ? 1 : 0,
            'kelas_5' => (request()->tingkat == 5) ? 1 : 0,
            'kelas_6' => (request()->tingkat == 6) ? 1 : 0,
            'kelas_7' => (request()->tingkat == 7) ? 1 : 0,
            'kelas_8' => (request()->tingkat == 8) ? 1 : 0,
            'kelas_9' => (request()->tingkat == 9) ? 1 : 0,
    ...
    public function update_kd(){
        ...
        $kd->kelas_1 = (request()->tingkat == 1) ? 1 : 0;
        $kd->kelas_2 = (request()->tingkat == 2) ? 1 : 0;
        $kd->kelas_3 = (request()->tingkat == 3) ? 1 : 0;
        $kd->kelas_4 = (request()->tingkat == 4) ? 1 : 0;
        $kd->kelas_5 = (request()->tingkat == 5) ? 1 : 0;
        $kd->kelas_6 = (request()->tingkat == 6) ? 1 : 0;
        $kd->kelas_7 = (request()->tingkat == 7) ? 1 : 0;
        $kd->kelas_8 = (request()->tingkat == 8) ? 1 : 0;
        $kd->kelas_9 = (request()->tingkat == 9) ? 1 : 0;
    ...
    public function add_cp(){
        ...
        if(request()->tingkat == 3 || request()->tingkat == 4){
            $fase = 'B';
        }
        if(request()->tingkat == 5 || request()->tingkat == 6){
            $fase = 'C';
        }
        if(request()->tingkat == 7 || request()->tingkat == 8 || request()->tingkat == 9){
            $fase = 'D';
        }
    ...
    public function tujuan_pembelajaran(){
        $data = Tujuan_pembelajaran::with(['cp.mata_pelajaran', 'kd.mata_pelajaran'])->where($this->kondisiTp())->orderBy(request()->sortby, request()->sortbydesc)
    ...
    public function upload_tp(){
        ...
        Excel::import(new TemplateTp(request()->mata_pelajaran_id, $id), storage_path('/app/public/'.$file_path));
    ...
    public function update_mapel(){
        ...
        if($find->update()){
            $data = [
                'icon' => 'success',
                'title' => 'Berhasil!',
                'text' => 'Nama Mata Pelajaran berhasil di perbaharui!',
            ];
        } else {
            $data = [
                'icon' => 'error',
                'title' => 'Gagal!',
                'text' => 'Nama Mata Pelajaran gagal di perbaharui!. Silahkan coba beberapa saat lagi!',
            ];
        }
        return response()->json($data);        
    }
