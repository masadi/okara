...
class WalasController extends Controller
{
    ...
    public function catatan_sikap(){
        ...
        if(loggedUser()->hasRole('waka', request()->periode_aktif)){
            $data = [
                'show' => FALSE,
                'form' => FALSE,
                'rombel' => NULL,
    ...
    public function ketidakhadiran(){
        ...
        $show = FALSE;
        $form = FALSE;
        if(loggedUser()->hasRole('wali', request()->periode_aktif) && !loggedUser()->hasRole('waka', request()->periode_aktif)){
