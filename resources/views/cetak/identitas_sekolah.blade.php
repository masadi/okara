...
<h3>RAPOR PESERTA DIDIK<br>{{nama_bentuk_pendidikan($get_siswa->rombongan_belajar->sekolah->bentuk_pendidikan_id)}}<br>({{id_bentuk_pendidikan($get_siswa->rombongan_belajar->sekolah->bentuk_pendidikan_id)}})</h3><br>
</div>
<table width="100%">
  <tr>
