...
?>
<div class="strong"><strong>B.&nbsp;&nbsp;Ekstrakurikuler</strong></div>
...
<br />
<div class="strong"><strong>C.&nbsp;&nbsp;Ketidakhadiran</strong></div>
...
?>
@if($get_siswa->rombongan_belajar->semester->semester == 2)
<div class="strong"><strong>D.&nbsp;&nbsp;{{$text_status}}</strong></div>
