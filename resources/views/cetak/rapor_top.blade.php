...
<h3>{{nama_bentuk_pendidikan($get_siswa->rombongan_belajar->sekolah->bentuk_pendidikan_id)}}</h3>
<h3>({{id_bentuk_pendidikan($get_siswa->rombongan_belajar->sekolah->bentuk_pendidikan_id)}})</h3><br>
<br>
<br>
<br>
<br>
