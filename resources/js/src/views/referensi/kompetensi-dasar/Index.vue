  ...
  <div>
    ...
    <b-modal ref="edit-modal" size="xl" title="Ubah Ringkasan Kompetensi Dasar" @hidden="resetModal" @ok="handleOk" ok-title="Simpan" ok-variant="primary">
      <b-overlay :show="loading_modal" rounded opacity="0.6" size="lg" spinner-variant="danger">
        <b-form-group label="Tingkat Kelas" label-for="tingkat">
        ...
        <b-form-group label="Deskripsi Kompetensi Dasar Lama" label-for="kompetensi_dasar">
          <b-form-textarea id="kompetensi_dasar" v-model="kompetensi_dasar" placeholder="Deskripsi Kompetensi Dasar Lama" rows="3" max-rows="6" disabled></b-form-textarea>
        </b-form-group>
        <b-form-group label="Deskripsi Kompetensi Dasar Baru" label-for="kompetensi_dasar_alias">
          <b-form-textarea id="kompetensi_dasar_alias" v-model="kompetensi_dasar_alias" placeholder="Deskripsi Kompetensi Dasar Baru" rows="3" max-rows="6"></b-form-textarea>
        </b-form-group>
      </b-overlay>
