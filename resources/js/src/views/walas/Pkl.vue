                    ...
                    <b-tbody>
                      <template v-for="(item, index) in data_siswa">
                        <b-tr>
                          <b-td>{{item.nama}}</b-td>
                          <b-td>
                            <b-form-input v-model="form.lokasi_prakerin[item.anggota_rombel.anggota_rombel_id]" :disabled="disabled" :state="lokasi_prakerin_state[item.anggota_rombel.anggota_rombel_id]" />
                          </b-td>
                          <b-td>
                          ...
                          <b-td>
                            <b-form-input v-model="form.lama_prakerin[item.anggota_rombel.anggota_rombel_id]" :disabled="disabled" :state="lama_prakerin_state[item.anggota_rombel.anggota_rombel_id]" />
                          </b-td>
                          <b-td>
                            <b-form-input v-model="form.keterangan_prakerin[item.anggota_rombel.anggota_rombel_id]" :disabled="disabled" :state="keterangan_prakerin_state[item.anggota_rombel.anggota_rombel_id]" />
                          </b-td>
...
export default {
  ...
  methods: {
    ...
    handleRombel(val){
      console.log(val);
      this.loadingForm = true
      this.$http.post('/waka/pkl', this.form).then(response => {
        this.loadingForm = false
        let getData = response.data
        this.allowed = getData.allowed
        this.semester_allowed = getData.semester_allowed
        this.nama_kurikulum = getData.nama_kurikulum
        this.tingkat = getData.tingkat_allowed
        this.data_dudi = getData.data_dudi
        console.log(getData);
      })
    }
