                ...
                <b-tbody>
                  <template v-for="(item, index) in data_siswa">
                    <b-tr>
                      <b-td>{{item.nama}}</b-td>
                      <b-td>
                        <b-form-select v-model="form.status[item.anggota_rombel.anggota_rombel_id]" :options="options" :disabled="disabled" @change="statusKenaikan(form.status[item.anggota_rombel.anggota_rombel_id], item.anggota_rombel.anggota_rombel_id, item.anggota_rombel.rombongan_belajar_id)"></b-form-select>
                      </b-td>
                      <b-td>
                        <b-form-input v-model="form.nama_kelas[item.anggota_rombel.anggota_rombel_id]" :disabled="disabled" />
                      </b-td>
                    </b-tr>
                  </template>
                </b-tbody>
