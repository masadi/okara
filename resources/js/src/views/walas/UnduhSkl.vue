            ...
            <b-table-simple bordered striped responsive>
              <b-thead>
                <b-tr>
                  ...
                  <b-th class="text-center">SKL</b-th>
                </b-tr>
              </b-thead>
              <b-tbody>
                <template v-for="(item, index) in data_siswa">
                  <b-tr>
                    ...
                    <b-td class="text-center">
                      <b-button variant="warning" :href="`/cetak/skl/${item.anggota_rombel.rombongan_belajar_id}/${item.anggota_rombel.anggota_rombel_id}`" target="_blank"><font-awesome-icon icon="fa-solid fa-file-pdf" size="2xl" /></b-button>
                    </b-td>
                  </b-tr>
                </template>
              </b-tbody>
