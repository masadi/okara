...
Route::group(['middleware' => 'auth:sanctum'], function () {
  ...
  Route::post('user/scan', [PostController::class, 'scan']);
  ...
  Route::group(['prefix' => 'rombongan-belajar'], function () {
    ...
    Route::post('/get-pembelajaran', [RombelController::class, 'get_pembelajaran']);
    Route::post('/insert-pembelajaran', [RombelController::class, 'insert_pembelajaran']);
  });
  Route::group(['prefix' => 'peserta-didik'], function () {
    ...
    Route::post('/kabupaten', [PdController::class, 'kabupaten']);
    Route::post('/kecamatan', [PdController::class, 'kecamatan']);
    Route::post('/desa', [PdController::class, 'desa']);
    Route::post('/simpan', [PdController::class, 'simpan']);
    Route::get('/referensi', [PdController::class, 'referensi']);
  });
  Route::group(['prefix' => 'referensi'], function () {
    ...
    Route::post('/update-mapel', [ReferensiController::class, 'update_mapel']);
  });
  Route::group(['prefix' => 'penilaian'], function () {
    ...
    Route::post('/hapus-sikap', [PenilaianController::class, 'hapus_sikap']);
  ...
  Route::group(['prefix' => 'walas'], function () {
    ...
    Route::post('/unduh-skl', [WalasController::class, 'unduh_skl']);
  });
